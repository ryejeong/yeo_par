  ...
  return (
    <>
      <LazyDiv className="card invitation">
        ...
        <div className="content">평생의 약속을 하려고 합니다.</div>
        <div className="break" />
        <div className="content">햇살이 뜨거울 때는 그늘이 되고,</div>
        <div className="content">비가 내릴 때는 우산이 되어</div>
        <div className="content">서로의 곁을 지키겠습니다.</div>
        <div className="break" />
